  ...
  return (
    <div className=' bg-pronhub text-white min-h-[100vh]'>
      ...
      <div className="pb-5">
        ...
        <Card key={3} project_id={3} icon="" project_name={"I hate next js"} submission_date={"10/19/2022"} description={'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed convallis lacus eu dolor semper, et mattis nibh lobortis. Morbi ac nisi mi. Curabitur dapibus enim eget feugiat cursus.'} score={"88"} download_link="https://www.google.com" viewer={5} student_ids={[1, 902, 222, 3421]} />
        <Card key={4} project_id={4} icon="" project_name={"Binusmaya v3.0"} submission_date={"10/19/2022"} description={'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed convallis lacus eu dolor semper, et mattis nibh lobortis. Morbi ac nisi mi. Curabitur dapibus enim eget feugiat cursus.'} score={"92"} download_link="https://www.google.com" viewer={5} student_ids={[1, 2, 3, 4, 5]} />
        <Card key={51} project_id={51} icon="" project_name={"Gojek"} submission_date={"10/19/2022"} description={'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed convallis lacus eu dolor semper, et mattis nibh lobortis. Morbi ac nisi mi. Curabitur dapibus enim eget feugiat cursus.'} score={"82"} download_link="https://www.google.com" viewer={5} student_ids={[1, 249, 2, 5]} />
        <Card key={6} project_id={6} icon="" project_name={"I hate next js"} submission_date={"10/19/2022"} description={'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed convallis lacus eu dolor semper, et mattis nibh lobortis. Morbi ac nisi mi. Curabitur dapibus enim eget feugiat cursus.'} score={"88"} download_link="https://www.google.com" viewer={5} student_ids={[1, 902, 222, 3421]} />
      </div>
    </div>
  )
}
